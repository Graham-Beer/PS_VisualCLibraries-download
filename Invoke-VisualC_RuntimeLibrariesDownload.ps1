...
.EXAMPLE
    ...
    # For Tree view of directory stucture at the end of script:
    .\Invoke-VisualC_RuntimeLibrariesDownload.ps1 -RootFolder C:\Setup\ -TreeView
.NOTES
    Created:	 2017-01-31
    Version:	 1.0
...
# displays header names of Fullname,ShortName,Source, DestinationFolder and DestinationFile
$Headers = "FolderContainer","FullName","ShortName","Source","DestinationFolder","DestinationFile"
...
"@ | ConvertFrom-Csv -Header $Headers # Convert here-string to a csv format for each header object
